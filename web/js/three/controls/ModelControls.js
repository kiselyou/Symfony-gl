     ...
     * @constructor
     */
    IW.ModelControls = function ( camera, scene, domElement, container ) {
    ...
    //            orbitControl.enableKeys = false;
         ...
         * @param {IW.ModelControls} scope - It current instance ModelControl
         */
